...
void DS1302_Init(u8 hour_s,u8 minute_s,u8 second_s)
{
	Ds1302_Single_Byte_Write(0x8e,0x00);
	
	Ds1302_Single_Byte_Write(0x80,second_s);
	Ds1302_Single_Byte_Write(0x82,minute_s);
	Ds1302_Single_Byte_Write(0x84,hour_s);
